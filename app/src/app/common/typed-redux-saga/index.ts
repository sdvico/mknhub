...
import { TakeableChannel, PuttableChannel, END, Task, FlushableChannel, Channel } from 'redux-saga';
import {
  ActionPattern,
  TakeEffect,
  Pattern,
...
export type SagaReturnType<S extends (...args: any[]) => any, T = ReturnType<S>> = T extends SagaIterator<infer RT>
  ? RT
...
export declare function take<A extends Action>(pattern?: ActionPattern<A>): SagaGenerator<A, TakeEffect>;
export declare function take<T>(
  channel: TakeableChannel<T>,
  multicastPattern?: Pattern<T>,
): SagaGenerator<T, ChannelTakeEffect<T>>;
export declare function take(pattern?: ActionPattern): SagaGenerator<any, TakeEffect>;

export declare function takeMaybe<A extends Action>(pattern?: ActionPattern<A>): SagaGenerator<A, TakeEffect>;
export declare function takeMaybe<T>(
  channel: TakeableChannel<T>,
  multicastPattern?: Pattern<T>,
): SagaGenerator<T, ChannelTakeEffect<T>>;
export declare function takeMaybe(pattern?: ActionPattern): SagaGenerator<any, TakeEffect>;
...
export declare function takeEvery<P extends ActionPattern, Fn extends (...args: any[]) => any>(
  pattern: P,
  worker: Fn,
...
export declare function takeEvery<A extends Action, Fn extends (...args: any[]) => any>(
  pattern: ActionPattern<A>,
  worker: Fn,
...
export declare function takeLatest<P extends ActionPattern, Fn extends (...args: any[]) => any>(
  pattern: P,
  worker: Fn,
  ...args: HelperWorkerParameters<ActionMatchingPattern<P>, Fn>
): SagaGenerator<never, ForkEffect<never>>;
...
export declare function takeLatest<A extends Action, Fn extends (...args: any[]) => any>(
  pattern: ActionPattern<A>,
  worker: Fn,
  ...args: HelperWorkerParameters<A, Fn>
): SagaGenerator<never, ForkEffect<never>>;
...
export declare function takeLeading<P extends ActionPattern, Fn extends (...args: any[]) => any>(
  pattern: P,
  worker: Fn,
  ...args: HelperWorkerParameters<ActionMatchingPattern<P>, Fn>
): SagaGenerator<never, ForkEffect<never>>;
...
export declare function takeLeading<A extends Action, Fn extends (...args: any[]) => any>(
  pattern: ActionPattern<A>,
  worker: Fn,
  ...args: HelperWorkerParameters<A, Fn>
): SagaGenerator<never, ForkEffect<never>>;
...
export declare function put<A extends Action>(action: A): SagaGenerator<A, PutEffect<A>>;
export declare function put<T>(channel: PuttableChannel<T>, action: T | END): SagaGenerator<T, ChannelPutEffect<T>>;

export declare function putResolve<A extends Action>(action: A): SagaGenerator<A, PutEffect<A>>;
...
export declare function call<Ctx, Fn extends (this: Ctx, ...args: any[]) => any>(
  ctxAndFn: [Ctx, Fn],
  ...args: Parameters<Fn>
): SagaGenerator<SagaReturnType<Fn>, CallEffect<SagaReturnType<Fn>>>;
export declare function call<Ctx, Fn extends (this: Ctx, ...args: any[]) => any>(
...
export declare function apply<Ctx, Fn extends (this: Ctx, ...args: any[]) => any>(
  ctx: Ctx,
  fn: Fn,
  args: Parameters<Fn>,
): SagaGenerator<SagaReturnType<Fn>, CallEffect<SagaReturnType<Fn>>>;
...
export declare function cps<Ctx, Fn extends (this: Ctx, ...args: any[]) => void>(
  ctxAndFn: [Ctx, Fn],
  ...args: CpsFunctionParameters<Fn>
): SagaGenerator<ReturnType<Fn>, CpsEffect<ReturnType<Fn>>>;
export declare function cps<Ctx, Fn extends (this: Ctx, ...args: any[]) => void>(
...
>(
  ctxAndFnName: [Ctx, Name],
  ...args: Parameters<Ctx[Name]>
): SagaGenerator<FixedTask<SagaReturnType<Ctx[Name]>>, ForkEffect<SagaReturnType<Ctx[Name]>>>;
export declare function fork<
  Ctx extends {
    [P in Name]: (this: Ctx, ...args: any[]) => any;
  },
...
export declare function fork<Ctx, Fn extends (this: Ctx, ...args: any[]) => any>(
  ctxAndFn: [Ctx, Fn],
  ...args: Parameters<Fn>
): SagaGenerator<FixedTask<SagaReturnType<Fn>>, ForkEffect<SagaReturnType<Fn>>>;
export declare function fork<Ctx, Fn extends (this: Ctx, ...args: any[]) => any>(
...
export declare function spawn<Ctx, Fn extends (this: Ctx, ...args: any[]) => any>(
  ctxAndFn: [Ctx, Fn],
  ...args: Parameters<Fn>
): SagaGenerator<FixedTask<SagaReturnType<Fn>>, ForkEffect<SagaReturnType<Fn>>>;
export declare function spawn<Ctx, Fn extends (this: Ctx, ...args: any[]) => any>(
...
export declare function cancel(tasks: Task[]): SagaGenerator<void, CancelEffect>;
...
export declare function flush<T>(channel: FlushableChannel<T>): SagaGenerator<T[], FlushEffect<T>>;

export declare function cancelled(): SagaGenerator<boolean, CancelledEffect>;

// eslint-disable-next-line @typescript-eslint/ban-types
export declare function setContext<C extends object>(props: C): SagaGenerator<void, SetContextEffect<C>>;

export declare function getContext<T = unknown>(prop: string): SagaGenerator<T, GetContextEffect>;

export declare function delay<T = true>(ms: number, val?: T): SagaGenerator<T, CallEffect<T>>;
...
export declare function throttle<P extends ActionPattern, Fn extends (...args: any[]) => any>(
  ms: number,
  pattern: P,
  worker: Fn,
  ...args: HelperWorkerParameters<ActionMatchingPattern<P>, Fn>
...
export declare function throttle<A extends Action, Fn extends (...args: any[]) => any>(
  ms: number,
  pattern: ActionPattern<A>,
  worker: Fn,
  ...args: HelperWorkerParameters<A, Fn>
...
export declare function debounce<P extends ActionPattern, Fn extends (...args: any[]) => any>(
  ms: number,
  pattern: P,
  worker: Fn,
  ...args: HelperWorkerParameters<ActionMatchingPattern<P>, Fn>
...
export declare function debounce<A extends Action, Fn extends (...args: any[]) => any>(
  ms: number,
  pattern: ActionPattern<A>,
  worker: Fn,
  ...args: HelperWorkerParameters<A, Fn>
...
export declare function all<T>(effects: T[]): SagaGenerator<EffectReturnType<T>[], AllEffect<T>>;
export declare function all<T extends { [key: string]: any }>(
  effects: T,
): SagaGenerator<{ [K in keyof T]: EffectReturnType<T[K]> }, AllEffect<T[keyof T]>>;

export declare function race<T>(effects: T[]): SagaGenerator<(EffectReturnType<T> | undefined)[], RaceEffect<T>>;
export declare function race<T extends { [key: string]: any }>(
  effects: T,
): SagaGenerator<{ [K in keyof T]: EffectReturnType<T[K]> | undefined }, RaceEffect<T[keyof T]>>;
