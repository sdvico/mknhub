...
import { appendErrors, Field, FieldError, FieldErrors, get, InternalFieldName, set } from 'react-hook-form';
import Yup from 'yup';
    ...
    async (values, context, options) => {
      try {
        if (schemaOptions.context && process.env.NODE_ENV === 'development') {
          console.info("You should not used the yup options context. Please, use the 'useForm' context object instead");
        }
