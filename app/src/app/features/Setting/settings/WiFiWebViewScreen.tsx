...
// Icon wrapper component to fix type issues
const IconWrapper = ({name, size, color, style}: any) => (
  <Icon name={name} size={size} color={color} style={style} />
);

const WiFiWebViewScreen = () => {
  ...
  return (
    <View style={[styles.container]}>
      ...
      <View style={[styles.header, {paddingTop: insets.top}]}>
        ...
        <Text style={styles.headerTitle}>Cài đặt WiFi</Text>
      ...
      <View style={styles.webviewContainer}>
        ...
        {error && (
          <View style={styles.errorContainer}>
            <IconWrapper name="cloud-offline" size={64} color="#999" />
...
export default WiFiWebViewScreen;
